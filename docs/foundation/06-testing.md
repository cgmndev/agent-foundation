...
| Unit puro | Vitest | Lógica pura con casos ricos (cálculos, parsing, reglas) | ~20-30% |
| E2E smoke | Playwright | 3-8 flujos críticos por la UI real | ~5-10% |
...
- Solo flujos de negocio críticos (login, flujo principal de valor, pago si existe). No es cobertura de UI exhaustiva.
